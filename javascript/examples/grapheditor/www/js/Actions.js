...
this.addAction('exportPNG', function() {
ui.showDialog(new ExportDialog(ui).container, 300, 296, true, true); });
	...
	this.addAction('saveJSON', function() {
	var xmlText= new XMLSerializer().serializeToString(editor.getGraphXml());
	const json1= xmlToJSON.parseString(xmlText);
	console.log(json1);
	...
	var isIE = false || !!document.documentMode;
            if (isIE) {
                window.navigator.msSaveBlob(blob1, "modelo.json");
            } else {
