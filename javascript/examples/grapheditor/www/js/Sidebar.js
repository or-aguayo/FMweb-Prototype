...
Sidebar.prototype.addGeneralPalette = function(expand)
{
	...
	var fns = [
	 	...
	 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;html=1;', 120, 60, '', 'Característica', null, null, 'rect rectangle box'),
	 		this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;startArrow=oval;startFill=1;endArrow=block;startSize=8;', 60, 0,'Obligatorio', 'Relación obligatoria', null, 'uml sequence message call invoke dispatch'),
	 			 		this.createEdgeTemplateEntry('html=1;verticalAlign=bottom;startArrow=oval;startFill=1;endArrow=block;startSize=8;', 60, 0,'Opcional', 'Relación opcional', null, 'uml sequence message call invoke dispatch'),
       // this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;', 80, 80, '', 'Circle', null, null, 'circle',lineTags + 'simple undirected plain blank no'),
...
*/
	 /*	this.addEntry('curve', mxUtils.bind(this, function()
	 	...
	 	*/
	 	...
	 	this.createEdgeTemplateEntry('endArrow=classic;dashed=1;startArrow=classic;html=1;', 50, 50, '', 'Excluye', null, lineTags + 'bidirectional'),
	 	this.createEdgeTemplateEntry('endArrow=classic;dashed=1;html=1;', 50, 50, '', 'Requiere', null, lineTags + 'directional directed'),
